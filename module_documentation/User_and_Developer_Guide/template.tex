...
\documentclass[11pt]{report} %fuente a 12pt (11 si es arial)

\usepackage[T1]{fontenc}
\usepackage[scaled]{uarial} %cambiar fuente a arial
...
%% para hacer una lista de abreviaturas
%\usepackage{nomencl}
%\makenomenclature

% Expresiones matemáticas
\usepackage{amsmath,amssymb,amsfonts,amsthm}
% Para formato de tablas
\usepackage{booktabs}
% Para tachar en las ecuaciones
...
\newcommand\setitemnumber[1]{\setcounter{enumi}{\numexpr#1-1\relax}}
	% previous line allows to manually set item number: \setItemnumber{X}
\usepackage[makeroom]{cancel} % para tachar ecuacion
	% \cancel{EQUATION LABEL HERE}
\usepackage{trimclip}
\def\AR{\clipbox{0pt 0pt .35em 0pt}{\textit{A}}\kern-.05emR}
	%AR symbol as "\AR"

% Idioma
\usepackage[UKenglish]{babel} % información sobre el paquete babel para español http://osl.ugr.es/CTAN/language/spanish/babel/base/spanish.pdf
%\usepackage[spanish, en-tabla]{babel}
...
%--
%Índice de abreviaturas. Si no se incluyen, comenta las líneas siguientes
%-
...
%CFD\hspace{10mm} Computational Fluid Dynamics\smallskip
%
%F1\hspace{10mm} Formula One\smallskip
%
%FS\hspace{10mm} Formula Student\smallskip

In order of first appearance:\medskip
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% EJEMPLOS DE TABLA, ECUACIÓN Y FIGURA
%
%\begin{table}
